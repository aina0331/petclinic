...
def init_db():
    with get_db() as conn:
        ...
        if conn.execute("SELECT COUNT(*) FROM CLIENT").fetchone()[0] == 0:
            ...
            (1,1,1,1,'2026-06-03','09:00','Confirmed'),
            (2,3,2,3,'2026-06-04','10:00','Pending'),
            (3,4,1,2,'2026-06-05','11:00','Confirmed'),
            (1,2,3,6,'2026-06-08','10:00','Pending'),
            (4,5,1,1,'2026-06-10','09:00','Completed'),
            (5,6,4,4,'2026-06-12','14:00','Pending'),
            (2,3,2,5,'2026-06-14','10:00','Confirmed'),
            (3,4,1,4,'2026-06-17','13:00','Cancelled');
            """)
